...
class Physionet2017DB(object):
    ...
    def __init__(self):
        ...
        # Set attributes
        self.db_url = 'https://archive.physionet.org/challenge/2017/training2017.zip'
        self.db_name = 'physionet2017'
        self.raw_path = os.path.join(DATA_DIR, 'dataset', 'raw')
        self.processed_path = os.path.join(DATA_DIR, 'dataset', 'processed')
        self.zip_file_path = os.path.join(self.raw_path, 'training2017.zip')
    ...
    def generate_processed_db(self):
        ...
        # Create data folder
        self._create_directory(directory=os.path.join(DATA_DIR, 'dataset', 'processed'))
        os.makedirs(os.path.join(DATA_DIR, 'dataset', 'processed', 'waveforms'), exist_ok=True)
        os.makedirs(os.path.join(DATA_DIR, 'dataset', 'processed', 'labels'), exist_ok=True)
    ...
    def _download_db(self):
        ...
        self._create_directory(directory=os.path.join(DATA_DIR, self.zip_file_path))
