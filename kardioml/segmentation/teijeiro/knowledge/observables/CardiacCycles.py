...
@author: T. Teijeiro
"""
from kardioml.segmentation.teijeiro.model import Observable, singleton_observable
from kardioml.segmentation.teijeiro.knowledge.observables.Rhythm import CycleMeasurements
