...
from kardioml.segmentation.teijeiro.utils.units_helper import msec2samples as m2s, phys2digital as p2d
import math
...
PWAVE_AMP = {
    SIG.Leads.MLI: p2d(0.75),
    SIG.Leads.MLII: p2d(0.75),
    SIG.Leads.MLIII: p2d(0.75),
    SIG.Leads.V1: p2d(0.5),
    SIG.Leads.V2: p2d(0.5),
    SIG.Leads.V3: p2d(0.5),
    SIG.Leads.V4: p2d(0.5),
...
SINUS_RR = Iv(m2s(545), m2s(1200))  # Normal rhythm RR limits (50-120 bpm)
