...
import kardioml.segmentation.teijeiro.utils.MIT.ECGCodes as C
import kardioml.segmentation.teijeiro.utils.MIT.MITAnnotation as MITAnnotation
import kardioml.segmentation.teijeiro.utils.MIT as MIT
import kardioml.segmentation.teijeiro.knowledge.observables as o
import kardioml.segmentation.teijeiro.knowledge.constants as K
from kardioml.segmentation.teijeiro.acquisition.signal_buffer import VALID_LEAD_NAMES
from kardioml.segmentation.teijeiro.knowledge.abstraction_patterns.segmentation.QRS import _tag_qrs
...
def interp2ann(interp, btime=0, offset=0):
    ...
    specific format for kardioml.segmentation.teijeiro.interpretations. This format includes the
